...
const PRECACHE = [
  ...
  'scripts/net-protocol.js',
  'scripts/online-state.js',
  'scripts/online-game.js',
  'scripts/net-overlay.js',
  'scripts/board-constants.js',
  'scripts/bot-ai.js',
  ...
  'scripts/overlay-base.js',
  'scripts/pawn-launch.js',
  'scripts/pawn-mini.js',
  ...
  'scripts/screens.js',
  'scripts/share-image.js',
  'scripts/seat-allocation.js',
  'scripts/storage-keys.js',
  'scripts/turn-rules.js',
  'scripts/wake-lock.js',
  ...
  'scripts/transport/event-hub.js',
